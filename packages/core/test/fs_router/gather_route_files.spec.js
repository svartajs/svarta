...
describe("fs_router", function () {
    describe("collectRouteFiles", function () {
        var FIXTURE_PATH = resolve(__dirname, ".fixture/routes");
        var expectedRoutes = [
            {
        ...
        it("should get correct files from folder", function () {
            return __awaiter(void 0, void 0, void 0, function () {
                var foundRoutes;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, collectRouteFiles(FIXTURE_PATH)];
                        case 1:
                            foundRoutes = _a.sent();
